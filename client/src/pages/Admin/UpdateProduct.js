...
const UpdateProduct = () => {
  ...
  const getAllCategory = async () =>{
    try {
      ...
      console.log(error)
      toast.error('Somethign went wrong in getting categories')
    }
  }
  ...
  const handleDelete = async () => {
    try {
      let answer = window.prompt('Are You Sure Want to delete this poduct')
      if(!answer) return
      ...
      <div className="col-md-9">
          ...
          <div className="m-1 w-75">
            ...
            <div className="mb-3">
              ...
              showSearch
              className='form-select mn-3' onChange={(value) => {
                setShipping(value)
              }}
